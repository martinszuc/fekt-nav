...
; sablonu je potreba prejmenovat na okna.asm
...
hButton			dd		0 		; window handle

;global variables
Message: 		resb 	MSG_size	;alokace mista v pameti pro zpravu

;Definiton WndClass structure
WndClass:
	istruc WNDCLASSEX
